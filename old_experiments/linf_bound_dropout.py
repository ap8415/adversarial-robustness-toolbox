...
from models.utils import load_mnist_vectorized, load_mnist
from old_models import neural_networks, convolutional
from models.metrics import mmd_evaluation
...
for eps in eps_values:
    ...
    for i in range(0, 5):
        ...
        # TODO: add other types of old_experiments; the only real variable here is the classifier.
