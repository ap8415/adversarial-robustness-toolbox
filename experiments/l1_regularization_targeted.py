...
if args.attack_type == 'l2':
    plt.plot(l1_regularization_levels, l2_normalized_min, linestyle='--', marker='o')
else:
    plt.plot(l1_regularization_levels, linf_normalized_min, linestyle='--', marker='o')

if args.attack_type == 'l2':
    plt.plot(l1_regularization_levels, l2_normalized, linestyle='--', marker='o')
else:
    plt.plot(l1_regularization_levels, linf_normalized, linestyle='--', marker='o')

if args.attack_type == 'l2':
    plt.plot(l1_regularization_levels, l2_normalized_max, linestyle='--', marker='o')
else:
    plt.plot(l1_regularization_levels, linf_normalized_max, linestyle='--', marker='o')

figname = '%s, L1 reg., targeted %s attack on %s' % \
...
plt.savefig('%s_%s_%s_l1_targeted.png' % (args.experiment_type, args.attack_type, args.dataset))
